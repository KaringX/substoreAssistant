import 'dart:io';
import 'package:substore_assistant/app/utils/app_registry_utils.dart';
import 'package:substore_assistant/app/utils/secure_storage_utils.dart';
...
abstract final class Did {
  ...
  static String _getDeviceIdKey() {
    if (Platform.isMacOS) {
      return 'substoreAssistantDevIdMacOS';
    }

    return 'substoreAssistantDevId';
  }
